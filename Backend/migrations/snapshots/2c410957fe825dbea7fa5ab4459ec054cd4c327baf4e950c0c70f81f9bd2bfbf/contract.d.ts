...
export type StorageHash =
  StorageHashBase<'2c410957fe825dbea7fa5ab4459ec054cd4c327baf4e950c0c70f81f9bd2bfbf'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Link: {
      ...
      readonly longUrl: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Link: {
      ...
      readonly longUrl: CodecTypes['pg/text@1']['input'];
          ...
          readonly Link: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly longUrl: { readonly column: 'longUrl' };
